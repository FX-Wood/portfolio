...
var projects = [
    {
        ...
        demo: {name: "Google Slides", url: "https://docs.google.com/presentation/d/1_DQdOYYhhWXCvhrtZeAZnX8gmu2dhpPYwVfh-g6rzWo/edit?usp=sharing"}
    },
    {
        name: "recipelf",
        order: 1,
        ...
        description: 'Generate new recipes using chatGPT and the ingredients in your kitchen. Built at AI Future Builder Hackathon 2023',
        descriptionLong: [
        ...
        technologies: 'Generative AI, React, Expressjs, JWT Auth, PostgreSQL, Hackathon',
    ...
    },
    {
        ...
        desktopOrder: 2,
        images: [
            '/img/likeable/likeable-0.png',
            '/img/likeable/likeable-1.png'
        ],
        description: 'Tinder for design options. Swipe left or right to be presented with personalized design recommendations. Built at AEC Tech Hackathon 2023',
        descriptionLong: [
    ...
    },
    {
        ...
        description: 'CLI Tool to help meetup organizers maintain the SeattleJS.com website',
        descriptionLong: [
        ...
        demo: {name: "NPM Package", url: 'https://npmjs.org/seattlejs-airtable-cli'},
    },
    {
        name: "Domblenon",
        order: 5,
...
const HomePage = () => {
    ...
    if (isMobile) {
        content = (
            // mobile content 
            <CardColumns>
                {projects.map((project) => <ProjectCard key={project.order} {...project}/>)}
            </CardColumns>
        )
    } else {
        content = (
